...
# install php
apt-get install -y php7.1 php7.1-cli php7.1-fpm php7.1-mysql php7.1-curl php7.1-dev php7.1-mcrypt php7.1-sqlite3 php7.1-mbstring php7.1-xml php7.1-zip php7.1-xdebug
