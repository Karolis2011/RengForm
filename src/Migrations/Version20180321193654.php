...
class Version20180321193654 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE Category (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, created DATETIME NOT NULL, orderNo INT NOT NULL, eventId INT DEFAULT NULL, categoryId INT DEFAULT NULL, INDEX IDX_FF3A7B972B2EBB6C (eventId), INDEX IDX_FF3A7B979C370B71 (categoryId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
