 ...
 */
final class Version20180916203249 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE EmailTemplate DROP sender, CHANGE id id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\'');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE Category CHANGE orderNo orderNo INT DEFAULT NULL');
        $this->addSql('ALTER TABLE EmailTemplate ADD sender VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, CHANGE id id INT AUTO_INCREMENT NOT NULL');
