 ...
 */
class Version20180913184631 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE FormConfig ADD type VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE FormConfig DROP type');
