 ...
 */
class Version20180406184936 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE FormConfig CHANGE config config LONGTEXT NOT NULL');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE FormConfig CHANGE config config JSON NOT NULL COLLATE utf8mb4_bin COMMENT \'(DC2Type:json_array)\'');
        $this->addSql('ALTER TABLE MultiEvent CHANGE endDate endDate DATETIME DEFAULT \'NULL\'');
        ...
        $this->addSql('ALTER TABLE Workshop CHANGE capacity capacity INT DEFAULT NULL, CHANGE formConfig_id formConfig_id CHAR(36) NOT NULL COLLATE utf8_unicode_ci COMMENT \'(DC2Type:guid)\'');
    }
}
