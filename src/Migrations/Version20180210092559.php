 ...
 */
class Version20180210092559 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE Event (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, date DATETIME NOT NULL, endDate DATETIME NOT NULL, place VARCHAR(255) NOT NULL, created DATETIME NOT NULL, organisationId INT DEFAULT NULL, INDEX IDX_FA6F25A362C39F2F (organisationId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE FormConfig (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, config LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', created DATETIME NOT NULL, organisationId INT DEFAULT NULL, INDEX IDX_950461C562C39F2F (organisationId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
